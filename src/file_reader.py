...
def jsonreader(input_path, conf_tipn, conf_sostt, conf_minqg, conf_maxqg, conf_pfak=0):
    ...
    with open(input_path, 'r', encoding='utf-8') as f:
        ...
        for i in range(len(data['data'])):
            ...
            if table_tipn_field == conf_tipn and (table_id_field not in table_list) and table_sostt_field == conf_sostt:
        ...
        return table_list, list_qg_0_ids, list_pfak  # передаем 3 списка: имя + дебит, нулевые дебиты и список давлений
